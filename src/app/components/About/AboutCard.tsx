  ...
  return (
    <div className="flex flex-col items-center justify-center mb-24 px-4 max-w-[90rem]">
      ...
      <div className="flex flex-col lg:items-center items-center gap-12 md:gap-10 lg:gap-12 md:items-start md:flex-row-reverse">
        <div className="w-full h-full flex-1 lg:max-w-[630px] lg:h-[730px]">
          <Image
            src={image as any}
            alt={title || "Image"}
            className="rounded-3xl h-full lg:max-w-full w-full object-cover object-center"
            width={0}
            height={0}
          />
        </div>
        <div className="flex-1 lg:max-w-[540px] md:py-4 md:pl-6 pr-0">
          <p className="max-w-4xl text-sm text-[#202125a3] lg:text-base lg:leading-6 dark:text-[#8d8d8d]">
            {description as any}
          </p>
        </div>
      </div>
